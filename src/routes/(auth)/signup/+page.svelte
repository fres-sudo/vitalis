...
<main class="flex flex-col items-center justify-center w-full h-full">
  <div
    class="rounded-xl shadow-[10px_10px_10px_10px_rgba(0,0,0,0.05)] items-center justify-center mt-6"
  >
    <div
      class=" rounded-xl bg-zinc-50 flex flex-col items-center justify-center p-6 m-2"
    >
      <h1 class="font-bold text-2xl pb-2">Registrati!</h1>
      <p class="text-sm text-muted-foreground font-medium text-center">
        Registrandomi accetto il conenso la <a class="text-primary" href="/"
          >Privacy Policy</a
        >
        e i
        <a class="text-primary" href="/">Termini di servizio</a>.
      </p>
      ...
      <p class="text-muted-foreground text-sm">
        Hai già un account? <a class="text-primary" href="/login">Accedi</a>
      </p>
    </div>
    <p
