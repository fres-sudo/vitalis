...
import { Callable, type Constructor, type ErrorMessage, type array, type conform } from "@arktype/util";
...
declare class _Type<t = unknown, $ = any> extends InnerRoot<t, $> {
    ...
    narrow<const predicate extends Predicate<distillOut<t>>>(predicate: predicate): Type<t extends MorphAst ? (In: this["tIn"]) => Out<inferPredicate<this["tOut"], predicate>> : inferPredicate<t, predicate>, $>;
    ...
    matching<const schema extends RegexSchema>(this: validateChainedConstraint<"regex", this>, schema: schema): Type<constrain<t, "regex", schema>, $>;
