...
import { type parseOperator, writeUnexpectedCharacterMessage } from "./shift/operator/operator.js";
/**
...
export type extractFinalizedResult<s extends StaticState> = s["finalizer"] extends ErrorMessage ? s["finalizer"] : s["finalizer"] extends "" ? s["root"] : state.error<writeUnexpectedCharacterMessage<`${s["finalizer"]}`>>;
export {};
