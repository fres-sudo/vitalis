import { type array, type propValueOf, type satisfy } from "@arktype/util";
...
export declare const writeUnboundableMessage: <root extends string>(root: root) => `Bounded expression ${root} must be a number, string, Array, or Date`;
