import { type Entry, type Json, type JsonData, type PartialRecord, type indexOf, type keySet, type keySetOf, type listable, type propValueOf, type requireKeys, type show } from "@arktype/util";
